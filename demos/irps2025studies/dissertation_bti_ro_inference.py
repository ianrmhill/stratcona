...
def vth_sensor_inference():
    ...
    for hyl in hyls:
        ...
        pri_entropy[hyl] = stratcona.engine.bed.entropy(
            pri_samples[hyl], partial(lp_f, site=hyl, test=htol_end_test, key=k1), limiting_density_range=(-838.8608, 838.8607))
    ...
    for hyl in hyls:
        ...
        pst_entropy[hyl] = stratcona.engine.bed.entropy(
            pst_samples[hyl], partial(lp_f, site=hyl, test=htol_end_test, key=k1), limiting_density_range=(-838.8608, 838.8607))
